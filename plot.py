...
class PlotLearningCurves:
    ...
    def __init__(self, tr_losses, val_losses, tr_accs, val_accs, tr_f1s, val_f1s, save_dir=None):
        ...
        # If save_dir is given -> save the learning curves to file
    ...
    def decorate(self, ylabel, fname, xlabel = "Epochs"):
    ...
    def visualize(self):
        ...
        self.decorate(ylabel = "Loss Values", fname = "loss_curve.png")
        ...
        self.decorate(ylabel = "Accuracy Scores", fname = "accuracy_curve.png")
        ...
        self.decorate(ylabel = "F1 Scores", fname = "f1_curve.png")
